...
namespace ICSharpCode.ILSpy
{
	...
	public partial class DebugSteps : UserControl
	{
		...
		void Decompile(int step, bool isDebug = false)
		{
			...
			_ = dockWorkspace.ActiveTabPage.ShowTextViewAsync(textView => textView.DecompileAsync(assemblyTreeModel.CurrentLanguage, assemblyTreeModel.SelectedNodes, null,
